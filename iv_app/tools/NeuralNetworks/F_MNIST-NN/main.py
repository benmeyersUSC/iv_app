...
class NeuralNetwork_F_MNIST:
    ...
    def gradient_descent(self, iterations, alpha, save_over=.85):
...
# Usage
nn = NeuralNetwork_F_MNIST(use_pretrained=True)
# nn.gradient_descent(iterations=500, alpha=0.18)
...
plot_image_from_vector(X_test[0])
