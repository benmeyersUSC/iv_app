...
class Mag7_Week:
    ...
    def clean_directory(self):
        save_dir = os.path.join(os.getcwd(), 'static/images/mag7')
...
class OI_Stock:
    ...
    def graph(self):
        ...
        plt.xticks([])
        plt.ylabel('Price')
        plt.title(f'{self.name} (${self.ticker}) Next Month Volatility\nIVx: % {self.iv*100:.2f}, +/- '
        ...
        save_dir = os.path.join(os.getcwd(), f'static/images/mag7')
...
def main():
    ...
    Mag7_Week(['AAPL', 'RDDT', 'SMCI', 'COIN', 'NVDA'])
